...
var FireLoopRef = /** @class */ (function () {
    ...
    **/
    FireLoopRef.prototype.on = function (event, filter) {
        ...
        if (event.match(/(value|change|stats)/)) {
            return rxjs_1.merge(this.pull(event, request), this.broadcasts(event, request));
        }
        else {
    ...
    **/
    FireLoopRef.prototype.operation = function (event, data) {
        ...
        return subject.asObservable().pipe(operators_1.catchError(function (error) { return rxjs_1.Observable.throw(error); }));
    };
    /**
    * @method buildId
    * @return {number}
