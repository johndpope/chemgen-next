 ...
 * @param search
 */
ExpSet.extract.workflows.getScoredExpSets = function (search) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        var sqlQuery = ExpSet.extract.buildNativeQueryGetDetailedScores(data, search, search.scoresExist);
        sqlQuery
            .then(function (rows) {
 ...
 */
ExpSet.extract.buildNativeQueryGetDetailedScores = function (data, search, hasManualScores) {
