...
/**
 * Api services for the `ReactomePathwayResultSet` model.
 */
var ReactomePathwayApi = /** @class */ (function (_super) {
    __extends(ReactomePathwayApi, _super);
    function ReactomePathwayApi(http, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ReactomePathwayResultSet` object.)
     * </em>
     */
    ReactomePathwayApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id ReactomePathway id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ReactomePathwayApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ReactomePathways/:id";
     ...
     */
    ReactomePathwayApi.prototype.getModelName = function () {
        return "ReactomePathwayResultSet";
    };
    ReactomePathwayApi = __decorate([
        core_1.Injectable(),
    ...
    return ReactomePathwayApi;
}(base_service_1.BaseLoopBackApi));
exports.ReactomePathwayApi = ReactomePathwayApi;
//# sourceMappingURL=ReactomePathway.js.map