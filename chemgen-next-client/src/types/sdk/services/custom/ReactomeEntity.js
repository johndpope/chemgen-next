...
/**
 * Api services for the `ReactomeEntityResultSet` model.
 */
var ReactomeEntityApi = /** @class */ (function (_super) {
    __extends(ReactomeEntityApi, _super);
    function ReactomeEntityApi(http, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ReactomeEntityResultSet` object.)
     * </em>
     */
    ReactomeEntityApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id ReactomeEntity id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ReactomeEntityApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ReactomeEntities/:id";
     ...
     */
    ReactomeEntityApi.prototype.getModelName = function () {
        return "ReactomeEntityResultSet";
    };
    ReactomeEntityApi = __decorate([
        core_1.Injectable(),
    ...
    return ReactomeEntityApi;
}(base_service_1.BaseLoopBackApi));
exports.ReactomeEntityApi = ReactomeEntityApi;
//# sourceMappingURL=ReactomeEntity.js.map