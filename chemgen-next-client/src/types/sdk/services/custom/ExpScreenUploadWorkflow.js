...
/**
 * Api services for the `ExpScreenUploadWorkflowResultSet` model.
 */
var ExpScreenUploadWorkflowApi = /** @class */ (function (_super) {
    __extends(ExpScreenUploadWorkflowApi, _super);
    function ExpScreenUploadWorkflowApi(http, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ExpScreenUploadWorkflowResultSet` object.)
     * </em>
     */
    ExpScreenUploadWorkflowApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpScreenUploadWorkflows";
        var _routeParams = {};
        var _postBody = {
            data: data
        };
     ...
     *
     * @param {any} id ExpScreenUploadWorkflow id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ExpScreenUploadWorkflowApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpScreenUploadWorkflows/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     *  - `status` – `{string}` -
     */
    ExpScreenUploadWorkflowApi.prototype.doWork = function (workflowData, customHeaders) {
        if (workflowData === void 0) { workflowData = {}; }
        var _method = "POST";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpScreenUploadWorkflows/dowork";
        var _routeParams = {};
        var _postBody = {};
        var _urlParams = {};
        if (typeof workflowData !== 'undefined' && workflowData !== null)
            _urlParams.workflowData = workflowData;
        var result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
        return result;
    };
    /**
     ...
     */
    ExpScreenUploadWorkflowApi.prototype.getModelName = function () {
        return "ExpScreenUploadWorkflowResultSet";
    };
    ExpScreenUploadWorkflowApi = __decorate([
        core_1.Injectable(),
    ...
    return ExpScreenUploadWorkflowApi;
}(base_service_1.BaseLoopBackApi));
exports.ExpScreenUploadWorkflowApi = ExpScreenUploadWorkflowApi;
